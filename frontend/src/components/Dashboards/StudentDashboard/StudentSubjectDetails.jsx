...
import { ChevronLeft, Lock, Unlock, Upload, CheckCircle, Clock, Eye } from 'lucide-react';

// --- Dummy Data ---
const subjectData = {
    'SUB-101': { name: 'Operating Systems', teacher: 'Dr. Evelyn Sharp', code: 'CS-301' },
    'SUB-102': { name: 'Computer Networks', teacher: 'Prof. Mark Webber', code: 'CS-302' },
    'SUB-103': { name: 'Database Management', teacher: 'Ms. Chloe Bennet', code: 'CS-304' },
    'SUB-104': { name: 'Artificial Intelligence', teacher: 'Dr. Evelyn Sharp', code: 'CS-401' },
};

const assignmentsData = [
    { id: 1, title: 'Assignment 1: Basics', status: 'Completed', isLocked: false, dueDate: '2025-10-15' },
    { id: 2, title: 'Assignment 2: Process Scheduling', status: 'Pending', isLocked: false, dueDate: '2025-11-30' },
    { id: 3, title: 'Assignment 3: Deadlocks', status: 'Pending', isLocked: true, dueDate: '2025-12-15' },
    { id: 4, title: 'Assignment 4: Memory Management', status: 'Pending', isLocked: true, dueDate: '2025-12-20' },
    { id: 5, title: 'Assignment 5: File Systems', status: 'Pending', isLocked: true, dueDate: '2026-01-10' },
];
                    ...
                    >
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-4 w-full md:w-auto">
                                <div className={`p-3 rounded-full ${assignment.isLocked ? 'bg-gray-800 text-gray-500' : 'bg-indigo-500/10 text-indigo-400'}`}>
                                    {assignment.isLocked ? <Lock className="h-6 w-6" /> : <Unlock className="h-6 w-6" />}
                                </div>
                                <div>
                                    <h3 className={`text-lg font-bold ${assignment.isLocked ? 'text-gray-500' : 'text-white'}`}>
                                        {assignment.title}
                                    </h3>
                            ...
                            <div className="w-full md:w-auto">
                                {assignment.isLocked ? (
                                    <button disabled className="w-full md:w-auto px-6 py-2 bg-gray-800 text-gray-500 font-medium rounded-lg cursor-not-allowed border border-gray-700">
                                        Locked
                                    </button>
